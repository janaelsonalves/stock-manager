...
export class StockProvider {
  ...
  constructor(public http: HttpClient, private firestore: AngularFirestore) {
    ...
    /* this.stocks = [
      { id: '1', symbol: "PETR4", price: 25.6, quantity: 500, fees: 1.1, sale_fee: 0.75, iss: 1.5 },
      { id: '2', symbol: "ABEV3", price: 26.7, quantity: 400, fees: 1.1, sale_fee: 0.75, iss: 1.5 },
      { id: '3', symbol: "ALPA4", price: 15.8, quantity: 300, fees: 1.1, sale_fee: 0.75, iss: 1.5 },
      { id: '4', symbol: "ITSA4", price: 9.5, quantity: 600, fees: 1.1, sale_fee: 0.75, iss: 1.5 },
      { id: '5', symbol: "USIM5", price: 10.06, quantity: 1500, fees: 1.1, sale_fee: 0.75, iss: 1.5 },
      { id: '6', symbol: "BBAS3", price: 35.01, quantity: 400, fees: 1.1, sale_fee: 0.75, iss: 1.5 },
    ] */
  }
  ...
  addStock(stock: Stock): Promise<any> {
    ...
    return this.firestore.collection(this.collection).doc(stock.id).set(stock);
  }

  deleteStock(stockId: any): Promise<any> {
    return this.firestore.collection(this.collection).doc(stockId).delete();
  }
